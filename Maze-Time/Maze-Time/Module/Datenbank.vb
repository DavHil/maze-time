Module Datenbank 'Dies ist die Datenbank des Spiels
    ...
    'Spiel Einstellungen
    Public Spiel_Name As String = "Maze-Time"
    ...
    Public Spiel_Hintergrundfarbe As Color = Color.LightBlue
    ...
    Public Launcher_Hintergrundfarbe As Color = Color.LightBlue
    ...
    Public Spielmenu_Hintergrundfarbe As Color = Color.LightBlue
    ...
    Public Level_Hintergrundfarbe As Color = Color.LightBlue
